...
async def next_page(bot, query):
    ...
    try:
        if settings['auto_delete']:
            btn.insert(0, 
                [
                    InlineKeyboardButton('Movie Bot 1', url='https://t.me/Movie_4_All_Bot'),
                    InlineKeyboardButton('Movie Bot 2', url='https://t.me/SG_Movie_Filter_Bot')
                ]
            )
    ...
    btn.insert(0, [
        InlineKeyboardButton("𝐇𝐎𝐖 𝐓𝐎 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 💡", url=HOW_DWLD_LINK)
    ])
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('Bᴀᴄᴋᴜᴘ Cʜᴀɴɴᴇʟ', url='https://t.me/saurabh_1710'),
                    InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/Developer_DM_Bot')
                ],[
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('Oᴜʀ Gʀᴏᴜᴘ', url='https://t.me/SG_Movies1')
                     ], [
                      InlineKeyboardButton('Bᴀᴄᴋᴜᴘ Cʜᴀɴɴᴇʟ', url='https://t.me/saurabh_1710'),
                      InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/Developer_DM_Bot')
                     ], [
...
async def auto_filter(client, msg, spoll=False):
    if not spoll:
        message = msg     
        stickers = [
            "CAACAgUAAxkBAAINFmVa-AnEQ_ftQYVVMKf6loD5leLVAAKcAAPIlGQUc48AAfPaxYX8HgQ","CAACAgQAAxkBAAIND2VWOC2UwJg6cfU8wcB4NVKNhcMfAALUAgACcnEXJVQhiQMcUCh8HgQ","CAACAgQAAxkBAAINDmVa-EuV3HBI6HqwM5RkSMZgggxGAALTAgACcnEXJbNQiJ9HtPcdHgQ","CAACAgUAAxkBAAING2Va-FwvnTMyoHIWUzriECl0-2gvAAKiAAPIlGQU_BpvPMzvnqweBA","CAACAgUAAxkBAAINHmVa-HMXEy5OmsL-7a4vg_2eR1qEAAKlAAPIlGQUeEOFXgFFtkYeBA","CAACAgQAAxkBAAINIWVa-I6jdY2kLeZE9g2dHptuAh8LAAL7CQACw_ApUe4aA27sIivjHgQ","CAACAgUAAxkBAAINImVa-I82H5iKcW7v4r_RFPBG4IAlAAKkAAPIlGQUgEMPlo9ZafoeBA","CAACAgUAAxkBAAINI2Va-JGT-TdT4eIL56dFaVy2d4-QAAKdAAPIlGQUqh3zB6luFzoeBA"]
