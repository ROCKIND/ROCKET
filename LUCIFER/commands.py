...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        await message.reply_photo(
            photo=random.choice(PICS),
            caption=script.START_TXT.format(temp.U_NAME, temp.B_NAME),
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🚀 Oᴜʀ Bᴀᴄᴋᴜᴘ Cʜᴀɴɴᴇʟ 🚀", url=invite_link.invite_link
                )
            ]
        ]
        ...
        await client.send_photo(
            photo="https://telegra.ph/file/09f7e668849d3c52fd9aa.jpg",
...
async def ping(_, message):
    kd = await message.reply_sticker('CAACAgQAAxkBAAINIWVa-I6jdY2kLeZE9g2dHptuAh8LAAL7CQACw_ApUe4aA27sIivjHgQ')
