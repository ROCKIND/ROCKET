...
API_ID = int(environ('API_ID', 25833520))
API_HASH = environ('API_HASH', '7d012a6cbfabc2d0436d7a09d8362af7')
BOT_TOKEN = environ('BOT_TOKEN', "6772475297:AAFGUV_Dm7U21YZsI4gYTmRRe8quinAespg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002005663269').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/SG_Movies1')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP',-1001941168314))
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/saurabh_1710/98')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001687647933))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001687647933))

# Bot Options
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "[{file_name}](https://t.me/saurabh_1710)\n\n<b>Fᴏʀ Oᴛʜᴇʀ (HD) Mᴏᴠɪᴇꜱ, Jᴏɪɴ Oᴜʀ Gʀᴏᴜᴘ 👉🏻 [𝐒𝐆 𝐌𝐎𝐕𝐈𝐄𝐒](https://t.me/SG_Movies1) 🙏🏻💝")
